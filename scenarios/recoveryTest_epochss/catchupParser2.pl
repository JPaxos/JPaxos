...
foreach (@$cuStarts){
    ...
    print "$id $run";
    printf " %f" ,  $recStart-$up;

    printf " %f" ,  $recSent-$up;
    printf " %f" ,  $recRcvd-$up;
    printf " %f" ,  $recAckSent-$up;
    printf " %f" ,  $recAckRecvd-$up;
    
    printf " %f" ,  $recCUStart-$up;
    printf " %f" ,  $starttime-$up;
    
    printf " %f" ,  $cuFirstQuerySent-$up;
    printf " %f" ,  $cuQueryRcvd-$up;
    

    if (defined $cuSnapSent){
        printf " %f" ,  $cuSnapSent-$up;
        printf " %f" ,  $cuSnapRcvd-$up;
        printf " %f" ,  $cuSnapAppl-$up;
    } else {
        printf " - - -";
    }
    printf " %f" ,  $cuRespSent-$up;
    printf " %f" ,  $endtime-$up;
    printf " %f" ,  $recCUEnd-$up;
    printf " %f" ,  $recEnd-$up;
