...
/**
 * Implementation of simple {@link PassiveRetransmitter} based on {@link Timer}. When
 ...
 */
public class PassiveRetransmitter implements Retransmitter {
     ...
     */
    public PassiveRetransmitter(Network network, int numReplicas, Dispatcher dispatcher) {
        assert network != null;
    ...
    private final static Logger logger = Logger.getLogger(PassiveRetransmitter.class.getCanonicalName());
