 ...
 */
public class BatchCatchUpQuery extends Message {
     ...
     */
    public BatchCatchUpQuery(int view, int instanceId) {
        super(view);
     ...
     */
    public BatchCatchUpQuery(DataInputStream input) throws IOException {
        super(input);
		instanceId = input.readInt();
	}

    public MessageType getType() {
        return MessageType.BatchCatchUpQuery;
    }
    ...
    public String toString() {
        return "BatchCatchUpQuery " +"(" + super.toString() + ")" +
