...
public class SnapshotMaintainer implements LogListener {
	...
	private MovingAverage snapshotByteSizeEstimate = new MovingAverage(0.75, Config.firstSnapshotSizeEstimate);
	...
	public void logSizeChanged(int newsize) {
		...
		long logByteSize = storage.getLog().byteSizeBetween(lastSnapshotInstance, storage.getFirstUncommitted());
